<aside class="main-sidebar" style="background-color: #6495ed;">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header" style="background-color:#6495ed; color: white;">REPORTS</li>
        <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        <li class="header" style="background-color:#6495ed; color: white;">MANAGE</li>
        
        <li><a href="attendance.php" style="background-color:#6495ed;"><i class="fa fa-calendar"></i> <span>Attendance</span></a></li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="header" style="background-color:#6495ed; color: white;">PRINTABLES</li>
