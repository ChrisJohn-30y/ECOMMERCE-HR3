...
class TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
		...
		$this->setTextShadow();  // This line is causing the error
...
if (isset($attr_array[2]) && isset($attr_array[2][$id])) {
    $dom[$key]['attribute'][strtolower($name)] = $attr_array[2][$id];
} else {
    // Handle the case where the key doesn't exist
    // For example, you can log an error or set a default value
    error_log("Warning: Missing index $id in \$attr_array[2].");
}
	 ...
	 * @protected static
	 */
	function unserializeTCPDFtagParameters($data) {
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	 ...
	 * @protected
	 */
	function _outSaveGraphicsState() {
		$this->_out('q');
	}
	 ...
	 * @protected
	 */
	 function _outRestoreGraphicsState() {
		$this->_out('Q');
	}
...
function deletePage($page) {
 ...
 function selectColumn($col='') {
	 ...
	 * @public
	*/
	 function setTextShadow($params=array('enabled'=>false, 'depth_w'=>0, 'depth_h'=>0, 'color'=>false, 'opacity'=>1, 'blend_mode'=>'Normal')) {
...
function stringLeftTrim($str, $replace='') {
	 ...
	 * @protected
	 */
	 function removeTagNamespace($name) {
